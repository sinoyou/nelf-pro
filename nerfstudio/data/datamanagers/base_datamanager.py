...
class DataManager(nn.Module):
    ...
    @abstractmethod
    def get_train_parser_output(self):
        """
        Returns the output of the train parser directly. The parsed data may be used for other purposes, 
        other than forming torch dataset and collating as batched data. 
        """

    @abstractmethod
    def get_eval_parser_output(self):
        """
        Returns the output of the eval parser directly. The parsed data may be used for other purposes, 
        other than forming torch dataset and collating as batched data. 
        """
...
class VanillaDataManagerConfig(InstantiateConfig):
    ...
    dataparser: AnnotatedDataParserUnion = NeLFProDataParserConfig()
...
class VanillaDataManager(DataManager):  # pylint: disable=abstract-method
    ...
    def setup_eval(self):
        ...
        if self.config.eval_image_indices is None:
    ...
    def get_train_parser_output(self):
        return self.train_dataparser_outputs
    
    def get_eval_parser_output(self):
        return self.eval_dataparser_outputs
